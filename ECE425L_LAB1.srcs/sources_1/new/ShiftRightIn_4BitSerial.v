...
// Create Date: 10/10/2015 05:13:20 PM
// Module Name: ShiftRightIn_4BitSerial
...
//          Module for Serial I/O Shift Right for 4 bits but uses only the data
//          in the reg to loop right
//////////////////////////////////////////////////////////////////////////////////


//                             Clock, Enable, DataOut
module ShiftRightIn_4BitSerial(Clk  ,E      , Dout);
    input Clk, E;
    output Dout;
    ...
    D_FF        dff1            (Clk  , 1'b0 , Dout    , Q[0]); 
    //                           Clock, Reset, Input, Output                                
    D_FF        dff2            (Clk  , 1'b0 , Q[0]    , Q[1]); 
    //                           Clock, Reset, Input, Output                                
    D_FF        dff3            (Clk  , 1'b0 , Q[1]    , Q[2]); 
    //                           Clock, Reset, Input, Output                                
    D_FF        dff4            (Clk  , 1'b0 , Q[2]    , Dout); 
